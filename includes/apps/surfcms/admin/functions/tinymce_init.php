...
//
    ...
    tinymce.init({
      ...
      content_css: [
                    ...
                    '../stylesheet.css?' + new Date().getTime()
                    ],
      relative_urls: false,
      convert_urls: false,
	  ...
	  setup: function(editor) {
		editor.addButton('osccustom', {
		  ...
		  menu: [{
			...
			text: 'Page: Full Content Width Block for Pages with Two Box Columns',
			onclick: function() {
			  editor.insertContent('<div class="grid_16 alpha omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Full Content Width Block for Pages with One Box Column',
			onclick: function() {
			  editor.insertContent('<div class="grid_20 alpha omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Half Content Width Blocks for Pages with Two Box Columns',
			onclick: function() {
			  editor.insertContent('<div class="grid_8 alpha">&nbsp;</div><div class="grid_8 omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Half Content Width Blocks for Pages with One Box Column',
			onclick: function() {
			  editor.insertContent('<div class="grid_10 alpha">&nbsp;</div><div class="grid_10 omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Third Content Width Blocks for Pages with Two Box Columns',
			onclick: function() {
			  editor.insertContent('<div class="grid_5 alpha">&nbsp;</div><div class="grid_6">&nbsp;</div><div class="grid_5 omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Third Content Width Blocks for Pages with One Box Column',
			onclick: function() {
			  editor.insertContent('<div class="grid_7 alpha">&nbsp;</div><div class="grid_6">&nbsp;</div><div class="grid_7 omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Quarter Content Width Blocks for Pages with Two Box Columns',
			onclick: function() {
			  editor.insertContent('<div class="grid_4 alpha">&nbsp;</div><div class="grid_4">&nbsp;</div><div class="grid_4">&nbsp;</div><div class="grid_4 omega">&nbsp;</div>');
			}
		  }, {
			text: 'Page: Quarter Content Width Blocks for Pages with One Box Column',
			onclick: function() {
			  editor.insertContent('<div class="grid_5 alpha">&nbsp;</div><div class="grid_5">&nbsp;</div><div class="grid_5">&nbsp;</div><div class="grid_5 omega">&nbsp;</div>');
			}
		  }, {
			...
			onclick: function() {
              ...
              editor.windowManager.open({
                  ...
                  onsubmit: function(e) {
                      // Insert content when the window form is submitted
                      editor.insertContent('<div class="ui-widget infoBoxContainer"><div class="ui-widget-header infoBoxHeading">' + e.data.headingtext + '</div><div class="ui-widget-content infoBoxContents" style="text-align: center;">' + e.data.bodytext + '</div></div>');
                  }
              });
			}
		  }, {
